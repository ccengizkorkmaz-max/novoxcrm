    ...
    try {
        ...
        switch (parsed.type) {
            case 'assistant-request': {
                ...
                const defaultInboundPrompt = `Sen ${assistantName}, Novo Gayrimenkul'ün satış asistanısın. Kendinden bahsederken ASLA "emlak asistanı", "emlak danışmanı" veya "gayrimenkul asistanı" deme, her zaman "satış asistanı" de.
...
- Araç başarıyla tamamlandığında müşteriye kataloğu e-posta adresine gönderdiğini bildir.\n`;
                ...
                let firstMessage = `Merhaba, Novo Gayrimenkul'e hoş geldiniz. Ben ${assistantName}, satış asistanıyım. Size nasıl yardımcı olabilirim?`
                if (isExistingCustomer && customer.full_name && customer.full_name !== 'Yeni Gelen Arama Adayı') {
                    ...
                    firstMessage = `Merhaba ${nameWithTitle}, Novo Gayrimenkul'e hoş geldiniz. Ben ${assistantName}, satış asistanıyım. Size nasıl yardımcı olabilirim?`
                }
