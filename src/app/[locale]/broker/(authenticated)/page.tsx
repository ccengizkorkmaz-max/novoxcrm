    ...
    return (
        <div className="max-w-5xl mx-auto space-y-4 pb-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <h1 className="text-lg font-bold text-slate-900 leading-none">{t('title')}</h1>
                        ...
                        <p className="text-[11px] text-slate-500 mt-1.5 font-medium">{t('welcome')}, {profile?.full_name}</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-3 gap-3">
                {[
                    { label: t('stats.total'), value: totalLeads, icon: Users, color: 'blue' },
                    { label: t('stats.active'), value: activeLeads, icon: Clock, color: 'orange' },
                    { label: t('stats.success'), value: wonLeads, icon: TrendingUp, color: 'green' }
                ].map((stat, i) => (
            ...
            <div className="grid gap-4 lg:grid-cols-3">
                        ...
                        <div className="divide-y divide-slate-50/60">
                            {leads && leads.length > 0 ? (
                                ...
                                <div className="p-8 text-center bg-slate-50/30">
                                    ...
                                    <p className="text-[11px] text-slate-400 font-medium">{t('recent.empty')}</p>
                                </div>
                            )}
                        </div>
                    </CardContent>
                ...
                <div className="space-y-4">
                        ...
                        <Card className="border-none shadow-sm bg-white rounded-xl overflow-hidden border border-slate-100">
                            ...
                            <CardContent className="p-4">
                                <div className="flex justify-between items-end mb-2">
                                    <div>
                                        <p className="text-[10px] text-slate-400 font-medium font-bold uppercase tracking-tighter">{t('level.progress')}</p>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[
                            { label: t('quickAccess.prices'), icon: Building2, href: '/broker/documents' },
                            { label: t('quickAccess.catalog'), icon: FileText, href: '/broker/documents' }
                        ].map((item, i) => (
