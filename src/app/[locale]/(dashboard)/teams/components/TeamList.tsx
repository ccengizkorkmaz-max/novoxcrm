                        ...
                        <form action={async (formData) => {
                            ...
                            <div className="grid gap-4 py-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="region" name="region" placeholder={t('regionPlaceholder')} />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="office_name">{t('office')}</Label>
                                    <Input id="office_name" name="office_name" placeholder={t('officePlaceholder')} />
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between text-sm font-medium">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {t('members')} ({team.team_members?.length || 0})
                                    </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between text-sm font-medium">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {t('projects')} ({team.team_project_assignments?.length || 0})
                                    </div>
                    ...
                    {editingTeam && (
                        <form action={async (formData) => {
                            ...
                            <div className="grid gap-4 py-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="edit-office">{t('office')}</Label>
