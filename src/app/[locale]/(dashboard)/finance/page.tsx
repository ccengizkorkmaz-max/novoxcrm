    ...
    return (
        <div className="flex flex-col gap-4">
            <div>
                ...
                <p className="text-muted-foreground text-sm">Proje bazlı cari hesaplar, borç/alacak takibi ve kıymetli evrak yönetimi.</p>
            </div>
            ...
            <Tabs defaultValue="dashboard" className="w-full">
                <TabsList className="bg-slate-100/50 p-1 border border-slate-200/50">
                    <TabsTrigger value="dashboard" className="data-[state=active]:bg-white shadow-sm gap-2">
                        <LayoutDashboard className="h-4 w-4" /> Özet
                    </TabsTrigger>
