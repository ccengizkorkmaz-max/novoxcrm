                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center flex-row-reverse">
                        <div className="order-2 lg:order-1 space-y-4">
                            {[
                                ...
                                { title: "Satış & Hakediş", desc: "Satış kapandığinde komisyonun otomatik hesaplanıp onaylanması." }
                            ].map((step, idx) => (
            ...
            <section className="py-24 border-t border-slate-900 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                            Yapay zeka destekli çözümlerle satış ekibinizi güçlendirin, müşteri deneyimini kişiselleştirin.
                        </p>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                        {aiSolutions.map((sol) => {
                            ...
                            return (
                                <Link key={sol.slug} href={`/cozum/${sol.slug}`} className="group p-6 rounded-2xl bg-slate-900/40 border border-slate-800 hover:border-violet-500/40 transition-all hover:shadow-lg hover:shadow-violet-500/5">
