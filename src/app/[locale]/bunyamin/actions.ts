...
// Use service role to bypass RLS since the user is not logging in via Supabase Auth
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL!
const supabaseServiceKey = process.env.SUPABASE_SERVICE_ROLE_KEY!
const supabase = createClient(supabaseUrl, supabaseServiceKey)

const BUNYAMIN_ID = 'edecfc64-e8de-4877-9e00-07e53c14ee94'
const AUTH_COOKIE_NAME = 'bunyamin_test_auth'
...
export async function getBunyaminLeads() {
    try {
        ...
        console.error('getBunyaminLeads error:', err)
