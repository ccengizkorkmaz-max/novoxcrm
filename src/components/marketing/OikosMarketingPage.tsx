                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
                        <div className="bg-white border-2 border-[#D8F0E8] rounded-2xl p-8 relative shadow-sm">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-2 text-sm text-gray-700">✓ 500 müşteri kaydı</div>
                                <div className="flex items-center gap-2 text-sm text-gray-700">✓ AI müşteri eşleştirme</div>
                                <div className="flex items-center gap-2 text-sm text-gray-700">✓ Temel bölge analizi</div>
                            </div>
                            <button 
                        ...
                        <div className="bg-white border-2 border-[#085041] rounded-2xl p-8 relative shadow-md">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-2 text-sm text-gray-700">✓ Sınırsız müşteri kaydı</div>
                                <div className="flex items-center gap-2 text-sm text-gray-700">✓ Tam AI özellik seti</div>
                                <div className="flex items-center gap-2 text-sm text-gray-700">✓ Gelişmiş satış tahmini</div>
                                <div className="flex items-center gap-2 text-sm text-gray-700">✓ Öncelikli destek</div>
                            </div>
                            <button 
